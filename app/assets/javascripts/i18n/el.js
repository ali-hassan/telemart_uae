...
(typeof(window) === 'undefined' ? global : window).I18n.translations["el"] = {
  "web": {
    ...
    "branding": {
      "create_own": "Θέλετε να δημιουργήσετε τη δική σας διαδικτυακή αγορά, όπως %{service_name}; %{learn_more}.",
      "learn_more": "Μάθε περισσότερα",
      "powered_by": "Το %{service_name} τροφοδοτείται από την πλατφόρμα %{sharetribe_link}."
    },
    "listing_card": {
      "add_picture": "Προσθήκη φωτογραφίας",
      "no_picture": "Καμία φωτογραφία"
    },
    "listings": {
      "confirm_discarding_unsaved_availability_changes_explanation": "Έχετε μη αποθηκευμένες αλλαγές στις πληροφορίες διαθεσιμότητάς σας. Εάν συνεχίσετε, αυτές οι αλλαγές θα χαθούν.",
      "confirm_discarding_unsaved_availability_changes_question": "Είστε βέβαιοι ότι θέλετε να απορρίψετε τις αλλαγές σας;",
      "edit_availability_header": "Διαθεσιμότητα",
      "edit_listing_availability": "Επεξεργασία διαθεσιμότητας καταχώρησης",
      "errors": {
        "availability": {
          "saving_failed": "Δεν μπορούμε να αποθηκεύσουμε τις αλλαγές διαθεσιμότητας. Προσπαθήστε να φορτώσετε ξανά τη σελίδα.",
          "something_went_wrong": "Δεν μπορούμε να εμφανίσουμε πληροφορίες διαθεσιμότητας. Προσπαθήστε να φορτώσετε ξανά τη σελίδα."
        },
        "working_hours": {
          "covers": "Καλύπτεται",
          "overlaps": "Υπερκαλύπτεται",
          "required": "Απαιτείται"
        }
      },
      "pricing_units": {
      ...
      "save_and_close_availability_editing": "Αποθήκευση και κλείσιμο",
      "working_hours": {
        "add_another_time_slot": "+ Προσθέστε και άλλη υποδοχή χρόνου",
        "default_schedule": "Προεπιλεγμένο χρονοδιάγραμμα",
        "end_time": "Ώρα λήξης",
        "i_am_available_on": "Είμαι διαθέσιμος...",
        "save": "Αποθήκευση",
        "start_time": "Ώρα έναρξης"
      }
    },
    "no_listings": {
      "sorry": "Λυπούμαστε, δεν βρέθηκαν καταχωρήσεις για τα κριτήρια αναζήτησής σας.",
      "try_other_search_terms": "Ίσως να δοκιμάσετε άλλους όρους αναζήτησης;"
    },
    "search": {
      "page": "Σελίδα",
      "page_of_pages": "από %{total_number_of_pages} "
    },
    "topbar": {
      ...
      "login": "Σύνδεση",
      "logout": "Αποσύνδεση",
      "manage_listings": "Οι καταχωρήσεις μου",
      "menu": "Μενού",
      "more": "Περισσότερα",
      "profile": "Προφίλ",
      "search_location_placeholder": "Τοποθεσία",
