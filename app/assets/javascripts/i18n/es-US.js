...
(typeof(window) === 'undefined' ? global : window).I18n.translations["es-US"] = {
  "web": {
    "admin": {
      "onboarding": {
        "guide": {
          ...
          "next_step": {
            ...
            "paypal": "Configura los pagos en línea",
            "skip_this_step_for_now": "Saltarse este paso por ahora",
            "slogan_and_description": "Añade la descripción y el eslogan"
          },
          "payments": {
            "advice": {
              "content": "Puedes leer más acerca de como desactivar los pagos en línea en %{disable_payments_link}.",
            ...
            "cta_separator": "o",
            "description_p1": "Si quieres permitir que tus usuarios paguen y acepten pagos en línea, y recibir comisiones por ello, necesitas conectar un sistema de pagos. Sharetribe soporta Stripe y Paypal. Una vez conectado(s), necesitas elegir la cuota o comisión por transacción.",
            "description_p2": "Alternativamente, puedes desactivar el sistema de pagos en línea por ahora.",
            "disable_it": "deshabilitarlo",
            "disable_payments": "Desactivar pagos en línea",
            ...
            "setup_payments": "Configurar pagos en línea",
            "title": "Step 5: Configura el sistema de pagos en línea"
          },
          ...
          "status_page": {
            ...
            "congratulation_p2": {
              ...
              "marketplace_guide_link": "guía práctica para hacer negocios con tu comunidad en línea"
            },
            "congratulation_p3": {
        ...
        "topbar": {
          ...
          "next_step": "Siguiente",
          "paypal": "Configurar pagos en línea",
    ...
    "admin2": {
      "landing_page": {
        "category": {
          ...
          "remove_confirm": "¿Realmente quiere eliminar la categoría \"%{name}\" de la página de inicio?"
        },
        "footer_menu_link": {
          "remove_body": "¿Realmente quieres eliminar el vínculo del pie de página \"%{name}\" de tu página de inicio?",
          "remove_title": "Eliminar %{name}"
        },
        "listings": {
          "not_valid_id_error": "La ID del anuncio no existe en tu marketplace. ¿Quizás fue un error? Revisa la ID e intenta de nuevo."
        },
        "location": {
          "remove": "Eliminar %{name}",
          "remove_confirm": "¿Realmente quieres quitar la ubicación \"%{name}\" de tu página de inicio?"
        }
      }
    },
    "branding": {
