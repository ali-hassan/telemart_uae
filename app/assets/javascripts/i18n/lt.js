...
(typeof(window) === 'undefined' ? global : window).I18n.translations["lt"] = {
  "web": {
    "admin": {
      "onboarding": {
        "guide": {
    ...
    "branding": {
      "create_own": "Norite sukurti savo elektroninės prekyvietės svetainę, pvz., %{service_name}? %{learn_more}.",
      "learn_more": "Sužinoti daugiau",
      "powered_by": "%{service_name} parengta pagal %{sharetribe_link} prekyvietės platformą."
    },
    "listing_card": {
      "add_picture": "Pridėti paveikslėlį",
      "no_picture": "Nėra paveikslėlio"
    },
    "listings": {
      "confirm_discarding_unsaved_availability_changes_explanation": "Turite neįrašytų pasikeitimų prie jūsų prieinamos informacijos. Jei tęsite, šie pakeitimai bus prarasti.",
      "confirm_discarding_unsaved_availability_changes_question": "Ar tikrai norite atsisakyti pakeitimų?",
      "edit_availability_header": "Pasiekiamumas",
      "edit_listing_availability": "Redaguoti skelbimo laiką",
      "errors": {
        "availability": {
          "saving_failed": "Negalime išsaugoti prieinamos informacijos. Pabandykite iš naujo įkelti puslapį.",
          "something_went_wrong": "Negalime rodyti prieinamos informacijos. Pabandykite iš naujo įkelti puslapį."
        },
        "working_hours": {
          "covers": "apima",
          "overlaps": "dubliuojasi",
          "required": "reikia"
        }
      },
      "pricing_units": {
      ...
      "save_and_close_availability_editing": "Įrašyti ir uždaryti",
      "working_hours": {
        "add_another_time_slot": "+ Pridėti kitą laiko tarpą",
        "default_schedule": "Numatytasis tvarkaraštis",
        "end_time": "Pabaigos laikas",
        "i_am_available_on": "Aš pasiekiamas...",
        "save": "Išsaugoti",
        "start_time": "Pradžios laikas"
      }
    },
    "no_listings": {
      "sorry": "Deja, nepavyko rasti paieškos kriterijų sąraše.",
      "try_other_search_terms": "Galbūt pabandykite kitus paieškos terminus?"
    },
    "search": {
      "page": "Puslapis",
      "page_of_pages": "iš %{total_number_of_pages}"
    },
    "topbar": {
      "admin_dashboard": "Administravimo skydas",
      "inbox": "Pašto dėžutė",
      "language": "Kalba",
      ...
      "more": "Daugiau",
      "profile": "Profilis",
      "search_location_placeholder": "Vieta",
